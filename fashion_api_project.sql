...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th8 04, 2024 lúc 04:18 PM
...
(10, '7MOJYIGO', 'vcxvx', '0999999999', 'fsd', '', 'sd', 'NEW', 0, 20000, 20000, b'0', '2024-05-14 10:47:02', '2024-08-01 10:45:22', 0, 1),
...
(13, 'A5K1TOQE', 'gdfgfdg', '0999999999', 'số 18 ngõ 222 tựu liệt,thanh trì, hà nội', '', 'vsd', 'PROCESS', 2300000, 30000, 2330000, b'0', '2024-05-14 10:47:02', '2024-08-01 10:45:22', 0, NULL),
...
(29, 'GB4ENHC1', 'nguyễn quang anh', '0999999999', 'số 18 ngõ 222 tựu liệt,thanh trì, hà nội', '', 'dfs', 'CANCEL', 0, 0, 0, b'0', '2024-05-14 10:47:02', '2024-08-01 10:45:22', 0, 1),
...
(34, 'I1TWS5QJ', 'quang anh', '0999999999', 'sdf', '', 'sd', 'NEW', 0, 0, 0, b'0', '2024-05-14 10:47:02', '2024-08-01 10:45:22', 0, 1),
(35, 'I8XDEQJH', 'nguyễn quang anh', '0999999999', 'số 18 ngõ 222 tựu liệt,thanh trì, hà nội', '', 'sd', 'PROCESS', 0, 0, 0, b'0', '2024-05-14 10:47:02', '2024-08-01 10:45:22', 0, 1),
...
(39, 'KT9P9ZMY', 'nguyễn quang anh', '0999999999', 'số 18 ngõ 222 tựu liệt,thanh trì, hà nội', '', 'dsf', 'NEW', 0, 20000, 20000, b'0', '2024-05-14 10:47:02', '2024-08-01 10:45:22', 0, 1),
...
(43, 'MSFDUEXY', 'nguyễn quang anh', '0999999999', 'số 18 ngõ 222 tựu liệt,thanh trì, hà nội', '', 'sd', 'NEW', 0, 0, 0, b'0', '2024-05-14 10:47:02', '2024-08-01 10:45:22', 0, 1),
...
(49, 'OCFAOWMB', 'fsdfsd', '0999999999', 'vd', '', 'd', 'NEW', 0, 30000, 30000, b'0', '2024-05-14 10:47:02', '2024-08-01 10:45:22', 0, 1),
...
(63, 'TLSY7TFT', 'dfgdf', '0999999999', 'fds', '', 'f', 'NEW', 0, 0, 0, b'0', '2024-05-14 10:47:02', '2024-08-01 10:45:22', 0, 1),
...
(66, 'UAEZV8YX', 'gdfgfdg', '0999999999', 'số 18 ngõ 222 tựu liệt,thanh trì, hà nội', '', 'vsd', 'NEW', 0, 30000, 30000, b'0', '2024-05-14 10:47:02', '2024-08-01 10:45:22', 0, 1),
(67, 'UAGHYL6A', 'quang anh', '0365151822', '4dvsdsf', '', 'd', 'NEW', 750000, 0, 750000, b'0', '2024-05-14 10:47:02', '2024-06-15 13:55:03', 0, 1),
(68, 'UZZHM3TR', 'nguyễn quang anh', '0999999999', 'số 18 ngõ 222 tựu liệt,thanh trì, hà nội', '', 'fs', 'NEW', 0, 30000, 30000, b'0', '2024-05-14 10:47:02', '2024-08-01 10:45:22', 0, 1),
...
(77, 'XRAPWYJI', 'quang anh', '0999999999', 'fđ', '', 'dgf', 'NEW', 0, 0, 0, b'0', '2024-05-14 10:47:02', '2024-08-01 10:45:22', 0, 1),
(78, 'YFJBR6YE', 'quang anh', '0365151822', '4dvsdsf', '', 'vd', 'NEW', 333333, 0, 333333, b'0', '2024-05-14 10:47:02', '2024-06-15 13:55:03', 0, 1),
(79, 'YHNB0POU', 'dsfds', '0999999999', 'f', '', 's', 'NEW', 0, 30000, 30000, b'0', '2024-05-14 10:47:02', '2024-08-01 10:45:22', 0, 1),
...
(84, 'ZUI23NIT', 'nguyễn quang anh', '0999999999', 'số 18 ngõ 222 tựu liệt,thanh trì, hà nội', '                        dsf', NULL, 'NEW', 0, 20000, 20000, b'0', '2024-05-14 10:47:02', '2024-08-01 10:45:22', 0, 1),
...
(520, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJuZ3V5ZW5xdWFuZ2FuaCIsInBob25lIjoiMDM2NDEwMDE5NiIsInJvbGUiOiJST0xFX01BTkFHRVIiLCJpYXQiOjE3MjI3ODA1NTEsImV4cCI6MTcyMjc4MTE1MX0.lBTD5pP0POr3JZ3zM26fvzHZZoH1dCdgQbc9wqRmJfQ', '2024-08-04 21:19:11', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJuZ3V5ZW5xdWFuZ2FuaCIsInBob25lIjoiMDM2NDEwMDE5NiIsInJvbGUiOiJST0xFX01BTkFHRVIiLCJpYXQiOjE3MjI3ODA1NTEsImV4cCI6MTcyMzM4NTM1MX0.KlEbAAhnQHXlMFqIoEUR774CZeJLDzAjqLPeKcihsMY', 1, '2024-09-03 21:09:11', 0, '2024-08-04 10:40:17', '2024-08-04 14:09:12'),
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `selling_products`  AS SELECT `p`.`product_name` AS `product_name`, `p`.`price` AS `price`, `p`.`discount_price` AS `discount_price`, `p`.`discount_percent` AS `discount_percent`, `p`.`total_size` AS `total_size`, `p`.`total_color` AS `total_color`, `p`.`image_background` AS `image_background`, `i`.`created_at` AS `created_at`, coalesce(sum(`id`.`quantity`),0) AS `total_quantity_sold`, coalesce(sum(`id`.`total_price`),0) AS `total_sales` FROM (((`invoices_detail` `id` left join `products_detail` `pd` on(`id`.`product_detail_id` = `pd`.`id`)) left join `products` `p` on(`pd`.`product_id` = `p`.`id`)) left join `invoices` `i` on(`id`.`invoice_id` = `i`.`id`)) WHERE `i`.`invoice_status` = 'SUCCESS' GROUP BY `p`.`product_name` ;
